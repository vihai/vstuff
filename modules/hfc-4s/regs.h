...
#define hfc_A_SL_CFG_V_ROUT_OUT_OFF		(0x0 << 6)
#define hfc_A_SL_CFG_V_ROUT_OUT_INTERNAL	(0x1 << 6)
#define hfc_A_SL_CFG_V_ROUT_OUT_STIO1		(0x2 << 6)
#define hfc_A_SL_CFG_V_ROUT_OUT_STIO2		(0x3 << 6)
#define hfc_A_SL_CFG_V_ROUT_IN_IGNORE		(0x0 << 6)
#define hfc_A_SL_CFG_V_ROUT_IN_LOOP		(0x1 << 6)
