/*
 * hfc.h - Zaptel driver for HFC-S PCI A based ISDN BRI cards
 *
...
#define hfc_DRIVER_NAME "hfc-pci"
#define hfc_DRIVER_PREFIX hfc_DRIVER_NAME ": "
#define hfc_DRIVER_DESCR "HFC-S PCI A Driver"
...
#define hfc_TX_FIFO_PRELOAD CHUNKSIZE + 2
